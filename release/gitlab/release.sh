...
curl --output-dir /tmp -LO https://github.com/aws-ia/cloudformation-gitlab-resource-providers/archive/refs/tags/$FILE_NAME
cd /tmp
unzip $FILE_NAME
cd cloudformation-gitlab-resource-providers-release-$RELEASE_NUMBER
zip source.zip -r *
