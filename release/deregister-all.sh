...
aws cloudformation --region $AWS_REGION list-type-versions --type $2 --type-name $TYPE_NAME | jq     '.TypeVersionSummaries[] | .Arn' | xargs -n1 aws cloudformation --region $AWS_REGION deregister-type --arn
