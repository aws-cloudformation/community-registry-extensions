...
import com.awscommunity.kms.encryptionsettings.model.aws.ec2.instance.AwsEc2Instance;
import com.awscommunity.kms.encryptionsettings.model.aws.ec2.instance.AwsEc2InstanceTargetModel;
import com.awscommunity.kms.encryptionsettings.model.aws.ec2.instance.BlockDeviceMapping;
import com.awscommunity.kms.encryptionsettings.model.aws.ec2.instance.Ebs;
...
@EqualsAndHashCode
@ToString
public final class AwsEc2InstanceKmsSettingsValidationImpl implements AwsKmsIntegratedService {
     ...
     */
    @Override
    public AwsEc2Instance getResourcePropertiesFromHookContext() {
        final HookContext hookContext = request.getHookContext();
        final AwsEc2InstanceTargetModel awsEc2InstanceTargetModel = hookContext
                .getTargetModel(AwsEc2InstanceTargetModel.class);
        final AwsEc2Instance awsEc2Instance = awsEc2InstanceTargetModel.getResourceProperties();
    ...
    public ProgressEvent<HookTargetModel, CallbackContext> validateAwsKmsSettings() {
        final AwsEc2Instance awsEc2Instance = getResourcePropertiesFromHookContext();

        final List<BlockDeviceMapping> blockDeviceMappings = awsEc2Instance.getBlockDeviceMappings();
        ...
        if (typeConfiguration.getValidateAmiBlockDeviceMappingEncryptionSettings().equals("yes")) {
            final String imageId = awsEc2Instance.getImageId();
