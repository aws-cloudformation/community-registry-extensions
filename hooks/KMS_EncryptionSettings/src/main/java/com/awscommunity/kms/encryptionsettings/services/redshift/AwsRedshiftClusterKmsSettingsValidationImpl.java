package com.awscommunity.kms.encryptionsettings.services.redshift;
...
import com.awscommunity.kms.encryptionsettings.model.aws.redshift.cluster.AwsRedshiftCluster;
import com.awscommunity.kms.encryptionsettings.model.aws.redshift.cluster.AwsRedshiftClusterTargetModel;
...
@EqualsAndHashCode
@ToString
public final class AwsRedshiftClusterKmsSettingsValidationImpl implements AwsKmsIntegratedService {
     ...
     */
    @Override
    public AwsRedshiftCluster getResourcePropertiesFromHookContext() {
        final HookContext hookContext = request.getHookContext();
        final AwsRedshiftClusterTargetModel awsRedshiftClusterTargetModel = hookContext
                .getTargetModel(AwsRedshiftClusterTargetModel.class);
        final AwsRedshiftCluster awsRedshiftCluster = awsRedshiftClusterTargetModel.getResourceProperties();
    ...
    public ProgressEvent<HookTargetModel, CallbackContext> validateAwsKmsSettings() {
        final AwsRedshiftCluster awsRedshiftCluster = getResourcePropertiesFromHookContext();

        final String kmsKeyId = awsRedshiftCluster.getKmsKeyId();
        if (kmsKeyId != null) {
        ...
        final Boolean encrypted = awsRedshiftCluster.getEncrypted();
