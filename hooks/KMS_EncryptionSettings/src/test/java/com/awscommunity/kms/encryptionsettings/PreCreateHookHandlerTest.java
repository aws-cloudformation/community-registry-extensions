...
/**
 * Test calls made on pre-create hook handler calls.
 */
@ExtendWith(MockitoExtension.class)
public class PreCreateHookHandlerTest extends PreCreatePreUpdateHookHandlerCommonTests {

    private PreCreateHookHandler handler;

    protected PreCreateHookHandlerTest() {
        super();
    }
