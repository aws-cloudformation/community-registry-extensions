...
1. Write the JSON schema describing your resource, `awscommunity-lambda-invoker.json`
2. Implement your resource handlers in `awscommunity_lambda_invoker/handlers.py`
