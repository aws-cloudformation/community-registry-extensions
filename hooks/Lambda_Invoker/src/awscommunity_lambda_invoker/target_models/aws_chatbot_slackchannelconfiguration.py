...
@dataclass
class AwsChatbotSlackchannelconfiguration(BaseModel):
    SlackWorkspaceId: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsChatbotSlackchannelconfiguration"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsChatbotSlackchannelconfiguration"]:
        if not json_data:
            return None
        dataclasses = {n: o for n, o in getmembers(sys.modules[__name__]) if isclass(o)}
        recast_object(cls, json_data, dataclasses)
        return cls(
            SlackWorkspaceId=json_data.get("SlackWorkspaceId"),
            SlackChannelId=json_data.get("SlackChannelId"),
...
_AwsChatbotSlackchannelconfiguration = AwsChatbotSlackchannelconfiguration
