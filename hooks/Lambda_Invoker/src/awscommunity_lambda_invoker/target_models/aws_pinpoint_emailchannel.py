...
@dataclass
class AwsPinpointEmailchannel(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsPinpointEmailchannel"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsPinpointEmailchannel"]:
        if not json_data:
            return None
...
_AwsPinpointEmailchannel = AwsPinpointEmailchannel
