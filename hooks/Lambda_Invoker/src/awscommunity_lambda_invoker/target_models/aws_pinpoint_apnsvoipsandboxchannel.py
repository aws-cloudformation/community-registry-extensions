...
@dataclass
class AwsPinpointApnsvoipsandboxchannel(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsPinpointApnsvoipsandboxchannel"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsPinpointApnsvoipsandboxchannel"]:
        if not json_data:
            return None
...
_AwsPinpointApnsvoipsandboxchannel = AwsPinpointApnsvoipsandboxchannel
