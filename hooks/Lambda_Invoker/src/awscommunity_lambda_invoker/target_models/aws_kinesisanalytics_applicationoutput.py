...
@dataclass
class AwsKinesisanalyticsApplicationoutput(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsKinesisanalyticsApplicationoutput"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsKinesisanalyticsApplicationoutput"]:
        if not json_data:
            return None
...
_AwsKinesisanalyticsApplicationoutput = AwsKinesisanalyticsApplicationoutput
