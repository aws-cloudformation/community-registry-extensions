...
@dataclass
class AwsPinpointApnsvoipchannel(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsPinpointApnsvoipchannel"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsPinpointApnsvoipchannel"]:
        if not json_data:
            return None
...
_AwsPinpointApnsvoipchannel = AwsPinpointApnsvoipchannel
