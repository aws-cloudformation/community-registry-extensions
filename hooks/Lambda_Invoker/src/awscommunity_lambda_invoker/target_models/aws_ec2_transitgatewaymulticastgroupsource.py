...
@dataclass
class AwsEc2Transitgatewaymulticastgroupsource(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsEc2Transitgatewaymulticastgroupsource"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsEc2Transitgatewaymulticastgroupsource"]:
        if not json_data:
            return None
...
_AwsEc2Transitgatewaymulticastgroupsource = AwsEc2Transitgatewaymulticastgroupsource
