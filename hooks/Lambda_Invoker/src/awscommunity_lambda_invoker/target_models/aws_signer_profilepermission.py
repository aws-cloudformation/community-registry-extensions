...
@dataclass
class AwsSignerProfilepermission(BaseModel):
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsSignerProfilepermission"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsSignerProfilepermission"]:
        if not json_data:
            return None
...
_AwsSignerProfilepermission = AwsSignerProfilepermission
