...
@dataclass
class AwsKinesisanalyticsv2Applicationreferencedatasource(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsKinesisanalyticsv2Applicationreferencedatasource"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsKinesisanalyticsv2Applicationreferencedatasource"]:
        if not json_data:
            return None
...
_AwsKinesisanalyticsv2Applicationreferencedatasource = AwsKinesisanalyticsv2Applicationreferencedatasource
