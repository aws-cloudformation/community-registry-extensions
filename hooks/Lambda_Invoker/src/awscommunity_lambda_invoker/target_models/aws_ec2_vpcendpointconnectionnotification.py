...
@dataclass
class AwsEc2Vpcendpointconnectionnotification(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsEc2Vpcendpointconnectionnotification"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsEc2Vpcendpointconnectionnotification"]:
        if not json_data:
            return None
...
_AwsEc2Vpcendpointconnectionnotification = AwsEc2Vpcendpointconnectionnotification
