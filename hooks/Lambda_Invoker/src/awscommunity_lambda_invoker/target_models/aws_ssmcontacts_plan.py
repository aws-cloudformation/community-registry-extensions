...
@dataclass
class AwsSsmcontactsPlan(BaseModel):
    ContactId: Optional[str]
    Stages: Optional[Sequence["_Stage"]]
    RotationIds: Optional[Sequence[str]]
    Arn: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AwsSsmcontactsPlan"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsSsmcontactsPlan"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            Stages=deserialize_list(json_data.get("Stages"), Stage),
...
_AwsSsmcontactsPlan = AwsSsmcontactsPlan
