...
@dataclass
class AwsGreengrassFunctiondefinitionversion(BaseModel):
    Id: Optional[str]
    DefaultConfig: Optional["_DefaultConfig"]
    Functions: Optional[Sequence["_Function"]]
    FunctionDefinitionId: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AwsGreengrassFunctiondefinitionversion"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsGreengrassFunctiondefinitionversion"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            FunctionDefinitionId=json_data.get("FunctionDefinitionId"),
        )


# work around possible type aliasing issues when variable has same name as a model
_AwsGreengrassFunctiondefinitionversion = AwsGreengrassFunctiondefinitionversion
