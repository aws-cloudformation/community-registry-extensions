...
@dataclass
class AwsGreengrassResourcedefinitionversion(BaseModel):
    ResourceDefinitionId: Optional[str]
    Resources: Optional[Sequence["_ResourceInstance"]]
    Id: Optional[str]

    @classmethod
    def _deserialize(
        cls: Type["_AwsGreengrassResourcedefinitionversion"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsGreengrassResourcedefinitionversion"]:
        if not json_data:
            return None
        dataclasses = {n: o for n, o in getmembers(sys.modules[__name__]) if isclass(o)}
        recast_object(cls, json_data, dataclasses)
        return cls(
            ResourceDefinitionId=json_data.get("ResourceDefinitionId"),
...
_AwsGreengrassResourcedefinitionversion = AwsGreengrassResourcedefinitionversion
