...
@dataclass
class AwsCloudformationResourceversion(BaseModel):
    Arn: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsCloudformationResourceversion"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsCloudformationResourceversion"]:
        if not json_data:
            return None
...
_AwsCloudformationResourceversion = AwsCloudformationResourceversion
