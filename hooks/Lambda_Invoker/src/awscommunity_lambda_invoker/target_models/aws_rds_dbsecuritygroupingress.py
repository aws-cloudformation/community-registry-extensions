...
@dataclass
class AwsRdsDbsecuritygroupingress(BaseModel):
    Id: Optional[str]
    CIDRIP: Optional[str]
    DBSecurityGroupName: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsRdsDbsecuritygroupingress"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsRdsDbsecuritygroupingress"]:
        if not json_data:
            return None
        ...
        return cls(
            ...
            DBSecurityGroupName=json_data.get("DBSecurityGroupName"),
...
_AwsRdsDbsecuritygroupingress = AwsRdsDbsecuritygroupingress
