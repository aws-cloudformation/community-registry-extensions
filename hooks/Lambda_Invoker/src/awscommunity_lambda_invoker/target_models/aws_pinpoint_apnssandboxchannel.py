...
@dataclass
class AwsPinpointApnssandboxchannel(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsPinpointApnssandboxchannel"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsPinpointApnssandboxchannel"]:
        if not json_data:
            return None
...
_AwsPinpointApnssandboxchannel = AwsPinpointApnssandboxchannel
