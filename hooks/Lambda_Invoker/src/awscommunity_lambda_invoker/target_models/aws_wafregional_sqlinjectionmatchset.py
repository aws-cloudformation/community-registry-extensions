...
@dataclass
class AwsWafregionalSqlinjectionmatchset(BaseModel):
    Id: Optional[str]
    ...
    @classmethod
    def _deserialize(
        cls: Type["_AwsWafregionalSqlinjectionmatchset"],
        json_data: Optional[Mapping[str, Any]],
    ) -> Optional["_AwsWafregionalSqlinjectionmatchset"]:
        if not json_data:
            return None
...
_AwsWafregionalSqlinjectionmatchset = AwsWafregionalSqlinjectionmatchset
