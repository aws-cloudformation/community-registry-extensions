# AwsCommunity::any::sleepTimer

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `awscommunity-any-sleeptimer.json`
2. Implement your resource handlers in `awscommunity_any_sleeptimer/handlers.py`
