...
1. Write the JSON schema describing your resource, `AwsCommunity-cloudfront-webaclassociation.json`
2. Implement your resource handlers in `AwsCommunity_cloudfront_webaclassociation/handlers.py`
